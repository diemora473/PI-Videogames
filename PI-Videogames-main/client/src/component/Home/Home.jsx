...
import { getVgames, filterCreated, getPlatforms, getGenres, sortvgames, filterGenre, filterPlat } from '../../action/action';
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <select className="hidden lg:block p-2 h-10 focus:outline-none bg-gray-800 hover:bg-princetonOrange font-bold border-none text-center text-white
                                    text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                    pointer" onChange={handleFilterGen}>
                                        <option value="PlayStation4">Genres</option>
                                        {
                                            genres?.map((el => {
                                                return (
                                    ...
                                    <select className="hidden lg:block p-2 h-10 focus:outline-none bg-gray-800 hover:bg-princetonOrange font-bold border-none text-center text-white
                                    text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                    pointer" onChange={e => handleFilterPlatforms(e)}>
                                        <option value="PlayStation4">Platforms</option>
                                        {
                                            platforms?.map((el => {
                                                return (
                        ...
                        <div class="-mr-2 flex md:hidden">
                            <button type="button" class="bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" aria-controls="mobile-menu" onClick={toggleOpen} aria-expanded="false">
                ...
                {open ? (
                    ...
                    <div class="md:hidden" id="mobile-menu">
                        ...
                        text-gray-300 hover:bg-gray-700 hover:text-white block px-24 py-2 rounded-md text-base font-medium" onChange={handleFilterPlatforms}>
                                <option value="PlayStation 4">Choose Platforms</option>
                                {
                                    platforms?.map((el => {
                                        return (
                                            <option key={el.name} value={el.name}>{el.name}</option>
                        ...
                        items-center justify-center
                        text-center text-white
                                    text-gray-300 hover:bg-gray-700 hover:text-white block px-24 py-2 rounded-md text-base font-medium" onChange={handleFilterGen}>
